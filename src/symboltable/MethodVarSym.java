...
public class MethodVarSym extends VarSym{
	...
	public MethodVarSym(String name, int line, int column, boolean is_static, ProtectionLevel protection, 
		boolean is_initialized, TypeSym type, boolean is_constant, MethodSym function, Sym parent, String path){
		super(name, line, column, is_static, protection, is_initialized, type, is_constant, parent, path);
